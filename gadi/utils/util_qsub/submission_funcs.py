...
if __name__ == '__main__':
    ...
    # pbs_script, oe_path = create_resource_script(python_script, folder, filename, walltime, mem, ncpus, env_variables, SU_project, data_projects, scratch_project, dependencies, email)
    # removed this: PYTHON_SCRIPT={python_script}, from the pbs script, as it is already passed as an environment variable
...
# prepend_path PATH $/home/565/cb4968/bin
# prepend_path PATH $/home/565/cb4968/.local/bin